...
For this Cloud Computing project, "Kafka Fraud Sentinel" was developed a distributed system that analyzes financial transactions in real time to catch potential frauds. 
