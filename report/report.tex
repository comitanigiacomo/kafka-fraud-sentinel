...
For this Cloud Computing project, a distributed system was developed that analyzes financial transactions in real time to catch potential frauds. 
...
\begin{itemize}
    \item About 30\% of the transactions have a high amount (between 1000 and 8500 EUR). Those exceeding 5000 EUR are flagged as Amount Fraud by the consumer.
